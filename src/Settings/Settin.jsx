...
import Addnewcard from "../AddNewCard/Newcard"
        ...
        <div className='set-afternav'>
            <section className='pass-sectt'>
                ...
                <div className='label-gap'>
                    <label className='pass-label' htmlFor="password">Current password</label>
                    <div className='Sett-Pass'>
                        ...
                        />
                     <button onClick={handleShow}  className="btns">{show ? <AiOutlineEye/> : <AiOutlineEyeInvisible/>}</button>
                    </div>
                </div>
                <div className='label-gap'>
                    <label className='pass-label' htmlFor="password">New password</label>
                    <div className='Sett-Pass'>
                        <input 
                        className='sett-pas' 
                        type={inputType} 
                ...
                <div className='label-gap'>
                    <label className='pass-label' htmlFor="password">Confirm password</label>
                    <div className='Sett-Pass'>
                        <input 
                        className='sett-pas' 
                        type={inputType} 
