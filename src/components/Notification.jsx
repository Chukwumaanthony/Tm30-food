...
import passchange from "../assets/images/notcard (2).png";
import passchange2 from "../assets/images/notcard (3).png";
import passchange3 from "../assets/images/notcard (1).png";
