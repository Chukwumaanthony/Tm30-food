...
import "./order.css";
import whiterice from "../assets/images/Maskrice.png";
import yam from "../assets/images/podyam.png";
import fish from "../assets/images/Maskfish.png";
    ...
    <div className="ordermap">
      {Order.map((Ord) => {
        return (
          <section
            className={
              Ord.progress == " In Progress" ? "work" : undefined || "works"
            }
          >
            <div>
              <img
